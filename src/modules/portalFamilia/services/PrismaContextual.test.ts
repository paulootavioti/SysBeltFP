...
import { GetLojaFamiliaService } from "./GetLojaFamiliaService";

describe("portal da família com tenant", () => {
  it("consulta o Prisma associado à requisição", async () => {
    findMany.mockResolvedValue([]);
    await expect(new GetLojaFamiliaService().execute()).resolves.toEqual([]);
