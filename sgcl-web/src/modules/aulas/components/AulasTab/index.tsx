...
import { IniciarAulaForm, type IniciarAulaFormData } from "../IniciarAulaForm";
...
export function AulasTab() {
  ...
  return (
    <div className="aulas-tab">
      <ErrorMessage message={erro} />

      <div className="aulas-tab-acoes-topo">
      ...
      {!turmaSelecionada ? (
        ...
        <>
          <div className="aulas-tab-drill-cabecalho">
