...
export const CORES_FAIXA: Record<string, { background: string; color: string }> = {
  ...
  "Cinza e Branca": { background: "linear-gradient(135deg, #FFFFFF 50%, #9CA3AF 50%)", color: "#111827" },
  "Cinza": { background: "#9CA3AF", color: "#111827" },
  "Cinza e Preta": { background: "linear-gradient(135deg, #9CA3AF 50%, #111827 50%)", color: "#FFFFFF" },
  "Amarela e Branca": { background: "linear-gradient(135deg, #FFFFFF 50%, #FACC15 50%)", color: "#111827" },
  "Amarela": { background: "#FACC15", color: "#111827" },
  "Amarela e Preta": { background: "linear-gradient(135deg, #FACC15 50%, #111827 50%)", color: "#FFFFFF" },
  "Laranja e Branca": { background: "linear-gradient(135deg, #FFFFFF 50%, #F97316 50%)", color: "#111827" },
  "Laranja": { background: "#F97316", color: "#FFFFFF" },
  "Laranja e Preta": { background: "linear-gradient(135deg, #F97316 50%, #111827 50%)", color: "#FFFFFF" },
