...
const NAV_ITEMS = [
  ...
  { to: "/assinaturas", label: "Assinaturas", icon: LuRepeat },
  { to: "/contratos", label: "Contratos", icon: LuFileText },
  { to: "/modelos-contrato", label: "Modelos de Contrato", icon: LuFileStack },
  ...
  { to: "/financeiro/formas-pagamento", label: "Formas de Pagamento", icon: LuBanknote },
